                ...
                <div className=" bg-white p-5 rounded">
                    ...
                    <form className='form-control '>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" placeholder='Confirm Password' autoComplete='off' name='Confirm Password' className='form-control' />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="email">
                        ...
                        <button type='submit' className='btn btn-primary w-100 rounded mt-3'>Register</button>
                        <p>Already Have an Account?</p>
                        <Link to="/login" className='btn text-white border w-100 bg-secondary  rounded text-decoration-none'>Login</Link>
                    </form>
                </div>
            </div>
